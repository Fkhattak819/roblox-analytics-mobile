...
This file is the audit trail between live Figma frames and native SwiftUI screens. It does not replace a live Figma read. Update an entry immediately before implementing or visually approving that screen.
...
| Design context `209:108` | Passed on 2026-08-22 | Re-read with Swift/SwiftUI context |
...
| Screen | Light node | Dark node | Live context | SwiftUI | Visual diff | Notes |
| --- | --- | --- | --- | --- | --- | --- |
...
- Figma returned source Roblox-mark SVG assets; they have not yet been preserved in the iOS asset catalog
...
SwiftUI view/component mapping:
